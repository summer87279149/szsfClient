...
- (void)viewDidLoad {
    [super viewDidLoad];
    UIImageView *backgroundImageView = [[UIImageView alloc]initWithImage:[UIImage  imageNamed:@"homeVCBackgroundImage"]];
...
//    self.tableView.backgroundView = backgroundImageView;
    ...
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:195/255.0 green:182/255.0 blue:159/255.0 alpha:1.0]];
